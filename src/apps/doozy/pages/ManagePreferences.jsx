    ...
    var ManagePreferences = React.createClass({
        ...
        handleSavePreferencesClick: function () {
            ...
            userStore.updatePrefs({
                email: this.refs.prefsEmail.value,
                emailNotifications: this.refs.prefsEmailNotifications.value,
                weekStarts: parseInt(this.refs.prefsWeekStarts.value),
                location: this.refs.prefsLocation.value,
                knownAs: this.refs.prefsKnownAs.value
            });

      ...
      return ( 
         <div style={styles.background}>
            <div style={styles.content}>
               <InputForm ref="form" title="Log Details" bindingContext={model} style={{color: '#2B90E8'}} labelStyle={{color: '#00AF27'}}>
                  <TextInput label="Date" field="date" type="date" />
                  <TextInput label="Details" field="details" type="memo" focus={true} />
                  <TextInput label="Duration" field="duration" type="text" />
               </InputForm>

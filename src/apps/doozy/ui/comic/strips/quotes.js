var strip = [
   {
      texts: [
         {
            text: `
“Tell me, Xenophon, what opinion have you hither to had of Critobulus? Have you placed him in the rank of the temperate and judicious; or with the debauched and imprudent?”
...
“And do you think, you fool,” added Socrates, “that kisses of love are not venemous, because you perceive not the poison? Know that a beautiful person is a more dangerous animal than scorpions, because these cannot wound unless they touch us; but beauty strikes at a distance.”
   ...
   },
   {
      texts: [
         {
            text: `“[…]for as they who use no bodily exercises are awkward and unwieldy in the actions of the body, so they who exercise not their minds are incapable of the noble actions of the mind, and have not courage enough to undertake anything worthy of praise, nor command enough over
themselves to abstain from things that are forbid.”
- Socrates`
         }
      ],
      refs: [
   ...
   },
   {
      texts: [
         {
            text: `“Vice and virtue in the same man are found.
And now they gain, and now they lose their ground.”
- Some poet before Socrates’ time.`
         }
      ],
      refs: [
         {
